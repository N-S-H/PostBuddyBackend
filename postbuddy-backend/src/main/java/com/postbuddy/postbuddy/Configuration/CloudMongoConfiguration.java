...
public class CloudMongoConfiguration {
    ...
    private String getConnectionString() {
        ...
        connectionBuilder.append("mongodb://")
                ...
                .append("@").append(connectionNodes).append("/?").append("authSource=admin")
                .append("&maxPoolSize="+maxPoolSize).append("&connectTimeoutMS="+connectTimeoutMs)
                .append("&wtimeoutMS="+writeTimeoutMs);
